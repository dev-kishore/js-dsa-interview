...
priorityQueue.enqueue("Angular", 2);
priorityQueue.enqueue("React", 1);
priorityQueue.enqueue("Node", 1);
priorityQueue.enqueue("Spring", 2);
priorityQueue.enqueue("Django", 3);
